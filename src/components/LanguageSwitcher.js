...
export default function LanguageSwitcher() {
  ...
  useEffect(() => {
    ...
    if (ltPost) {
      ...
      // Map other paths
      const enSlugs = {"/apie-mus": "/about-us", "/kontaktai": "/contact", "/privatumo-politika": "/privacy-policy", "/blogas": "/blog", "/wordpress-svetainiu-kurimas": "/wordpress-website-development", "/svetainiu-prieziura": "/website-maintenance"};
      const ltSlugs = {"/about-us": "/apie-mus", "/contact": "/kontaktai", "/privacy-policy": "/privatumo-politika", "/blog": "/blogas", "/wordpress-website-development": "/wordpress-svetainiu-kurimas", "/website-maintenance": "/svetainiu-prieziura"};
